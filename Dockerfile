...
WORKDIR /src
COPY ["Blog.Server/Blog.Server.csproj", "Blog.Server/"]
COPY ["blog.client/blog.client.esproj", "blog.client/"]
RUN dotnet restore "./Blog.Server/Blog.Server.csproj"
COPY . .
WORKDIR "/src/Blog.Server"
